CREATE TABLE `notifications` (
    ...
    CONSTRAINT `ck_notifications_status` CHECK (
        `status` COLLATE utf8mb4_0900_as_cs IN ('PENDING', 'SENDING', 'SENT', 'FAILED', 'DEAD')),
    ...
    CONSTRAINT `ck_notifications_channel` CHECK (`channel` COLLATE utf8mb4_0900_as_cs = 'DEFAULT'),
...
CREATE TABLE `notification_attempts` (
    ...
    CONSTRAINT `ck_attempts_trigger` CHECK (`trigger` COLLATE utf8mb4_0900_as_cs
        IN ('INITIAL', 'AUTO', 'MANUAL')),
