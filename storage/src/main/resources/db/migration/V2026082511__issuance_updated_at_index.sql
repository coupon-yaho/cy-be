...
--
-- 첫 청크의 afterId = 0 이 결정적입니다. 진도는 JobInstance 안에서만 살고 스케줄러가
-- 주기마다 asOf 를 새로 잡으므로, **5분마다 오는 실행은 언제나 첫 청크가 afterId = 0**
-- 입니다 — 하루 288회입니다. (같은 asOf 를 다시 도는 재시작만 죽은 자리에서 이어받습니다.)
--
