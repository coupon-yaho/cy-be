...
public class AdminIssuanceHistoryService {
    ...
    private final AdminIssuanceHistoryReader reader;
    ...
    public AdminIssuanceHistoryResult getHistories(AdminIssuanceHistoryQuery query) {
        ...
        AdminIssuanceHistoryReadResult readResult = reader.read(query, snapshotAt);
        return calculator.calculate(readResult, query.limit());
    }
}
