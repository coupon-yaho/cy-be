 ...
 *
 * <p>DB 권위값은 기술 중립 {@link AdminCampaignDataReader}에서 읽고, 아직 연결되지 않은 발급 Counter와
 * 대기열은 값을 만들지 않은 {@link SourceStatus#PENDING}으로 계산기에 전달합니다.</p>
 */
public class AdminCouponMetricsService {
    ...
    public CouponMetricsSnapshot getCouponMetrics(long couponId, MetricsWindow window) {
        ...
        CouponMetricsSource source = new CouponMetricsSource(
                value.couponId(), value.campaign(), value.stock(), pending(), pending(),
