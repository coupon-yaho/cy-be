...
/** 관리자 쿠폰 회차 상세 조회의 존재 여부와 DB 원천값입니다. */
public record AdminCouponRoundDetailData(DetailAvailability availability, DetailValue value) {

    /** 찾음·없음·DB 조회 불가 상태가 값을 잘못 동반하지 않도록 검증합니다. */
    public AdminCouponRoundDetailData {
    ...
    /** 한 쿠폰 회차의 기본 정보, 재고, 보유 상태와 전이 집계 원천입니다. */
    public record DetailValue(
            long couponId,
            String couponName,
            String brandName,
            EngineVersion engineVersion,
            CouponMetricsSource.CouponRoundRuntime couponRound,
        ...
        public DetailValue(
            ...
            this(couponId, couponName, brandName, EngineVersion.V1,
                    couponRound, stock, holdingCounts, transitions);
        }
    }
}
