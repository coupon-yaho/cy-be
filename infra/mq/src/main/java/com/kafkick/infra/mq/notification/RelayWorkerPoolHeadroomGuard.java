...
public class RelayWorkerPoolHeadroomGuard {
     ...
     * 접수 요청에 남겨야 하는 커넥션 수.
     *
     * <p><b>실측에서 나온 값이다.</b> 풀 13 에서 워커 11(둘 남음)까지는 요청 p99 가 1ms
     * 아래인데, 워커 12(하나 남음)에서 4ms 로 뛴다. 그 두 점을 가르는 값이 2 다.
     *
     * <p>3 이상으로 올리면 <b>안 재 본 영역을 막게 된다</b> — 워커 11 이 실제로는 멀쩡한데
     * 거절당한다. 1 로 내리면 잰 나쁜 점(워커 12)을 통과시킨다.
     */
    static final int REQUEST_HEADROOM = 2;
