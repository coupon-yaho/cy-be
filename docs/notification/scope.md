...
### T2 (CY-643) — 파이프라인 ([pipeline.md](pipeline.md#발송-파이프라인)) · 검증 1~6
### T3 (CY-644) — 조회 ([admin-api.md](admin-api.md#관리자-조회)) · 검증 7~12
### T4 (CY-645) — 재발송 ([admin-api.md](admin-api.md#수동-재발송)) · 검증 13~18
