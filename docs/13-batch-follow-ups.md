...
> 규칙 31개가 로드되고 mock 리시버까지 배선됐다(CY-359 당시 22개, CY-446 이 아홉을 더했다). CI 가 `promtool check config` 와
