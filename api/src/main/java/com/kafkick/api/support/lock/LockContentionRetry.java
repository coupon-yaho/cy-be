 ...
 * 락 대기로 50초를 쓰면 응답은 이미 예산을 크게 넘긴다.
 *
 * <p><b>"새 시도를 안 시작한다" 도 절대 보장은 아니다.</b> 마감을 확인한 뒤 다음
 * {@code action.get()} 을 부르기까지 스레드가 밀리면 마감 후에 시도가 시작될 수 있다.
 * 이 코드가 하는 것은 <b>물러설 때마다 마감을 보고, 지났으면 더 안 하는 것</b>까지다 —
 * 최선 노력이지 상한이 아니다. 처음엔 보장처럼 적었는데 리뷰가 잡았다.
 */
@Component
