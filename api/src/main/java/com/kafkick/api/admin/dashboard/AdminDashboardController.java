...
public class AdminDashboardController {
    ...
    /**
     * 운영현황·쿠폰 회차 상세·브랜드 분석 요청을 각 구체 Service에 위임하도록 구성합니다.
     *
     * @param adminOverviewService 관리자 첫 화면 응답을 조립하는 구체 Service
     * @param adminCouponMetricsService 쿠폰 회차 상세 지표를 계산하는 구체 Service
     ...
     *
     * <p>{@code couponId}는 쿠폰 회차 식별자이며 양수만 허용하는 필수 쿼리 파라미터입니다. {@code window}는
     ...
     * @throws BusinessException 요청한 브랜드·쿠폰 회차가 없거나 소속 관계가 다른 경우
     */
